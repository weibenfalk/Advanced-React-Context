...
const AnotherContext = React.createContext<null | AnotherContextType>(null);
...
export const useAnotherContext = () => {
  ...
  if (!anotherContext) throw new Error('You need to use this hook inside a context provider');
