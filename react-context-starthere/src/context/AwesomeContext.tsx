...
export const AwesomeContext = React.createContext<null | AwesomeContextType>(null);
...
export const useAwesomeContext = () => {
  ...
  if (!awesomeContext) throw new Error('You need to use this context inside a provider');
